...
import Getaway from '../assets/getwaway.jpg';
...
function Portfolio(){
    return (
        <div className='projects'>
            ...
            <Project name="GetAwayWithBae MERN App" image={Getaway} githubUrl='https://github.com/LondaNH/Iheartmusic'websiteUrl='https://fierce-tundra-81897.herokuapp.com/'/>
